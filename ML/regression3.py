...
#validation dataset
metadata_6371 = metadata[metadata.fill_num == 6364]
...
hidden2 = Dense(300, activation='leaky_relu', kernel_regularizer=regularizers.l1_l2(l1=1e-15, l2=1e-16), bias_regularizer=regularizers.l2(1e-4), activity_regularizer=regularizers.l2(1e-5))(hidden1)
...
plt.plot(metadata_6371.time, transp_validation, "b .")
plt.plot(metadata_6371.time, transp_predicted_validation, "r +")
plt.show()
